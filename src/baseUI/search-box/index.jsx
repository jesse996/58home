...
const SearchBoxstyle = styled.div`
  ...
  width: 100%;
  display: flex;
  padding: 0.1759rem /* 19/108 */;
  height: 0.815rem /* 88/108 */;
  background-color: white;
  .server-search-input {
    position: relative;
    /* height: 0.9629rem; */
    height: 0.81rem /* 77/108 */;
    ...
    .server-search-place {
      ...
      padding: 0.093rem /* 10/108 */;
      display: flex;
      line-height: 0.4167rem;
      font-size: 0;
      .server-search-border {
        /* display: inline-block; */
        width: 0.6759rem /* 73/108 */;
        height: 0.3704rem /* 40/108 */;
        margin-left: 0.222rem /* 24/108 */;
        padding-top: 0.18rem /* 8/108 */;
        .server-search-img {
          width: 0.3703rem;
          /*  height: 0.3703rem; */
        }
        ...
        <div className="server-search-input">
          <div className="server-search-place">
            <p className="server-search-border">
              <img alt="" className="server-search-img" src={imgSearch}></img>
            </p>
            <input
              type="text"
              placeholder="擦玻璃"
