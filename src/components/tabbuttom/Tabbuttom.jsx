            ...
            <div
              ...
              style={
                index === 1
                  ...
                  : { backgroundPosition: '-1.685rem 0px' }
              }
            ></div>
            <div
              className="planet"
              style={index === 1 ? { color: '#ec564b' } : {}}
            >
              全部服务
            </div>
          </Link>
            ...
            <div
              ...
              style={
                index === 2
                  ...
                  : { backgroundPosition: '-2.528rem 0px' }
              }
            ></div>
            <div
              className="planet"
              style={index === 2 ? { color: '#ec564b' } : {}}
            >
              消息
            ...
            <div
              ...
              style={
                index === 3
                  ...
                  : { backgroundPosition: '-3.333rem 0px' }
              }
            ></div>
            <div
              className="planet"
              style={index === 3 ? { color: '#ec564b' } : {}}
            >
              我的
            </div>
          </Link>
