      ...
      <div className="frame-top">
        <FrameSale>
          ...
          <div className="frame-sale__hot">
            <span className="iconfont logo" style={{ color: '#ff5348' }}>
              &#xe63f;
            </span>
        ...
        <FrameImgView>
          ...
          <div className="frame-imgView">
            <div className="frame-imgView__title">宝宝护理</div>
            <div className="frame-imgView__box">
              <img src={ad_6} alt="" className="imgView-name" />
            </div>
          </div>
          <div className="frame-imgView">
            <div className="frame-imgView__title">宝宝护理</div>
            <div className="frame-imgView__box">
              <img src={ad_7} alt="" className="imgView-name" />
            </div>
          </div>
          <div className="frame-imgView">
            <div className="frame-imgView__title">宝宝护理</div>
            <div className="frame-imgView__box">
              <img src={ad_8} alt="" className="imgView-name" />
            </div>
          </div>
        </FrameImgView>
      </div>
