...
function My(props) {
  ...
  recentnum = localStorage.getItem('recentNum')
    ? localStorage.getItem('recentNum')
    : recentnum
      ...
      <div className="center">
        ...
        <div className="info info-card">
          {infocard.map((item, index) => {
            ...
            return (
              <InfoCard
                num={item.infocardnum}
                num_name={item.infocardname}
                key={index}
                handleonclick={handleClickRecent}
                param={item.param}
              />
            )
          })}
        ...
        <div className="order">
          <div className="order-warp-head">
            ...
            <div
              className="order-warp-head-L"
              onClick={() => {
                handleClick('/order/all')
              }}
            >
              查看全部
            </div>
        ...
        <div className="tool-server">
          ...
          <div className="tool-server-icon">
            {toolservercard.map((item, index) => {
              return <ToolserverCard name={item.imgsrctext} key={index} />
            })}
          </div>
        </div>
      </div>
