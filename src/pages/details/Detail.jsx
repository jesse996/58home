...
const Detail = (props) => {
  ...
  useEffect(() => {
    ...
    reqdetail(decodeURIComponent(props.location.search.split('=')[1])).then(
      (res) => {
  ...
  useEffect(() => {
    ...
    getrecentNumData()
  }, [getinitorderData, getrecentNumData, orderdata.length])
  ...
  useEffect(() => {
    ...
    for (let tab of tabs) {
      ...
      // console.log("tabsH",h);
      let start = tab.offsetTop
      // ranges.push([base, newH])
      ranges.push([start, start + h])
    }
  ...
  return (
    <>
      {/* 服务规格弹出框 */}
      <SpecificationsPopup
        handleOnclickBack={handleonclickchange}
        handleOnclickComfirm={handleOnclickComfirm}
        display={downDisplay}
      />
      ...
      <div ref={ref}>
        <div data-rtab="商品">
            ...
            <div className="swiper-container">
              <div className="swiper-wrapper ">
                <div className="swiper-slide">
                  <img
                    alt=""
                    data-src="https://images.daojia.com/pic/commodity/online/9275c6db764bbe4cb4f83aa5a7dbdd39.png?x-oss-process=image/auto-orient,0/format,webp"
                    data-index="0"
                ...
                <div className="swiper-slide">
                  <img
                    alt=""
                    data-src="https://images.daojia.com/pic/commodity/online/1a247a084e9d63fc0ba80cdc5612e998.png?x-oss-process=image/auto-orient,0/format,webp"
                    data-index="1"
                    className="swiper-lazy"
                  />
                  <div className="swiper-lazy-preloader"></div>
                ...
                <div className="swiper-slide">
                  <img
                    alt=""
                    data-src="https://images.daojia.com/pic/commodity/online/f67c550b6c0b42da7b40d5559bd80075.png?x-oss-process=image/auto-orient,0/format,webp"
                    data-index="2"
                    className="swiper-lazy"
                  />
                  <div className="swiper-lazy-preloader"></div>
          ...
          <ImgIndex>
            <div
              className="swiper-pagination swiper-pagination-custom"
              style={{ bottom: '2px' }}
            ></div>
          </ImgIndex>
          <Title>
            ...
            <div className="type">擦玻璃</div>
            <div className="describe">
              <span>双面精细擦窗，服务有标准，清洁看得见</span>
            </div>
            <div className="tabs">
              <span className="icon-shezhi iconfont">&#xe785;随时预约</span>
              <span className="icon-shezhi iconfont">&#xe785;专业清洗工具</span>
              <span className="icon-shezhi iconfont">&#xe785;阿姨专业培训</span>
            </div>
          </Title>
          <Discount>
            <div className="micon">优惠</div>
